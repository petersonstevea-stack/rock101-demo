...
export default function LoginScreen({ onLogin }: LoginScreenProps) {
  ...
  return (
    <BrandedBackground
      ...
      position="center"
    >
      <div className="flex min-h-screen flex-col items-center justify-center gap-8 px-6 py-10 text-white">
        <img
          src="/sor-logo.png"
          alt="School of Rock"
        ...
        <div className="text-center">
          ...
          <p className="mt-4 text-base text-zinc-200 md:text-lg">
        ...
        <div className="w-full max-w-md rounded-2xl border border-zinc-700/80 bg-black/70 p-6 backdrop-blur-md">
          <input
            ...
            className="w-full rounded-xl border border-zinc-700 bg-zinc-900/90 px-4 py-3 text-white outline-none focus:border-red-500"
          />
          ...
          <div className="mt-8 rounded-xl border border-zinc-800 bg-zinc-900/90 p-5">
